...
sku_frequency  = 4.00    # Controls SKU selection probability distribution
...
max_dependence = 0.80    # Maximum correlation strength between related SKUs

# Group Structure Parameters
group_link     = 0.04    # Ratio of SKUs that get random connections outside their group
ind_chance     = 0.20    # Ratio of SKUs not assigned to any cluster
