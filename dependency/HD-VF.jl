# Transaction Generation Parameters — High Dependencies, Variable Frequency (HD-VF)
# Dependency structure: 50% strong groups, 30% medium groups, 20% independent SKUs
