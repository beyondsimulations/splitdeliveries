...
dep_strength_strong = (0.50, 0.95)  # Co-purchase probability range for strong groups
dep_strength_medium = (0.05, 0.50)  # Co-purchase probability range for medium groups
...
mean_group_min = 5         # Minimum mean group size
